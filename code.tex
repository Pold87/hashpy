...
\documentclass{article}
    ...
    \def\lt{<}
    % Document parameters
    \title{Distant Supervision - The End}
...
{\color{incolor}In [{\color{incolor}830}]:} \PY{k+kn}{import} \PY{n+nn}{os}\PY{o}{,} \PY{n+nn}{csv}\PY{o}{,} \PY{n+nn}{tweepy}\PY{o}{,} \PY{n+nn}{ucto}\PY{o}{,} \PY{n+nn}{time}
          \PY{k+kn}{import} \PY{n+nn}{numpy} \PY{k+kn}{as} \PY{n+nn}{np}
          \PY{k+kn}{import} \PY{n+nn}{pandas} \PY{k+kn}{as} \PY{n+nn}{pd}
          \PY{k+kn}{from} \PY{n+nn}{sklearn.ensemble} \PY{k+kn}{import} \PY{n}{ExtraTreesClassifier}
          \PY{k+kn}{from} \PY{n+nn}{sklearn.feature\PYZus{}extraction.text} \PY{k+kn}{import} \PY{n}{TfidfTransformer}
          \PY{k+kn}{from} \PY{n+nn}{sklearn.feature\PYZus{}extraction.text} \PY{k+kn}{import} \PY{n}{CountVectorizer}
          \PY{k+kn}{from} \PY{n+nn}{sklearn.linear\PYZus{}model} \PY{k+kn}{import} \PY{n}{SGDClassifier}\PY{p}{,} \PY{n}{LogisticRegression}
          \PY{k+kn}{from} \PY{n+nn}{sklearn.cross\PYZus{}decomposition} \PY{k+kn}{import} \PY{n}{PLSRegression}
          \PY{k+kn}{from} \PY{n+nn}{sklearn} \PY{k+kn}{import} \PY{n}{tree}
          \PY{k+kn}{from} \PY{n+nn}{sklearn.svm} \PY{k+kn}{import} \PY{n}{LinearSVC}\PY{p}{,} \PY{n}{NuSVC}
          \PY{k+kn}{from} \PY{n+nn}{sklearn.ensemble} \PY{k+kn}{import} \PY{n}{BaggingClassifier}
          ...
          \PY{k+kn}{from} \PY{n+nn}{sklearn.base} \PY{k+kn}{import} \PY{n}{BaseEstimator}
          ...
          \PY{k+kn}{from} \PY{n+nn}{sklearn.neighbors} \PY{k+kn}{import} \PY{n}{NearestCentroid}
          
          \PY{k+kn}{import} \PY{n+nn}{logging}
          
          \PY{k+kn}{from} \PY{n+nn}{tweepy.streaming} \PY{k+kn}{import} \PY{n}{StreamListener}
          \PY{k+kn}{from} \PY{n+nn}{tweepy} \PY{k+kn}{import} \PY{n}{Stream}
          
          \PY{k+kn}{from} \PY{n+nn}{pynlpl.clients.frogclient} \PY{k+kn}{import} \PY{n}{FrogClient}
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}831}]:} \PY{n}{os}\PY{o}{.}\PY{n}{chdir}\PY{p}{(}\PY{l+s}{\PYZdq{}}\PY{l+s}{/home/pold/PycharmProjects/twitter\PYZhy{}tutorial/}\PY{l+s}{\PYZdq{}}\PY{p}{)}
\end{Verbatim}


    \subsection{General Classifier}



    \subsection{Read Aggressive Tweets from TSV files}


    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}878}]:} \PY{k}{def} \PY{n+nf}{create\PYZus{}key}\PY{p}{(}\PY{n}{x}\PY{p}{)}\PY{p}{:}
              \PY{l+s+sd}{\PYZsq{}\PYZsq{}\PYZsq{}Create a file name from a number\PYZsq{}\PYZsq{}\PYZsq{}}
              \PY{k}{return} \PY{l+s}{\PYZdq{}}\PY{l+s}{tweets/fold\PYZus{}}\PY{l+s}{\PYZdq{}} \PY{o}{+} \PY{n+nb}{str}\PY{p}{(}\PY{n}{x}\PY{p}{)} \PY{o}{+} \PY{l+s}{\PYZdq{}}\PY{l+s}{.txt}\PY{l+s}{\PYZdq{}}
          
          \PY{c}{\PYZsh{} Create a list of file names of the aggressive tweets.}
          \PY{n}{files} \PY{o}{=} \PY{p}{[}\PY{n}{create\PYZus{}key}\PY{p}{(}\PY{n}{x}\PY{p}{)} \PY{k}{for} \PY{n}{x} \PY{o+ow}{in} \PY{n+nb}{xrange}\PY{p}{(}\PY{l+m+mi}{0}\PY{p}{,}\PY{l+m+mi}{10}\PY{p}{)}\PY{p}{]}
          
          \PY{c}{\PYZsh{} Store everything in a pandas data frame.}
          \PY{n+nb}{list} \PY{o}{=} \PY{p}{[}\PY{p}{]}
          \PY{k}{for} \PY{n+nb}{file} \PY{o+ow}{in} \PY{n}{files}\PY{p}{:}
              \PY{n}{df} \PY{o}{=} \PY{n}{pd}\PY{o}{.}\PY{n}{read\PYZus{}table}\PY{p}{(}\PY{n+nb}{file}\PY{p}{,}
                                 \PY{n}{names} \PY{o}{=} \PY{p}{(}\PY{l+s}{\PYZsq{}}\PY{l+s}{category}\PY{l+s}{\PYZsq{}}\PY{p}{,} \PY{l+s}{\PYZsq{}}\PY{l+s}{user}\PY{l+s}{\PYZsq{}}\PY{p}{,} \PY{l+s}{\PYZsq{}}\PY{l+s}{date}\PY{l+s}{\PYZsq{}}\PY{p}{,} \PY{l+s}{\PYZsq{}}\PY{l+s}{time}\PY{l+s}{\PYZsq{}}\PY{p}{,} \PY{l+s}{\PYZsq{}}\PY{l+s}{message}\PY{l+s}{\PYZsq{}}\PY{p}{)}\PY{p}{,} 
                                 \PY{n}{header} \PY{o}{=} \PY{n+nb+bp}{None}\PY{p}{,}
                                 \PY{n}{index\PYZus{}col} \PY{o}{=} \PY{n+nb+bp}{None}\PY{p}{)}
              \PY{n+nb}{list}\PY{o}{.}\PY{n}{append}\PY{p}{(}\PY{n}{df}\PY{p}{)}
                  
          \PY{n}{frame} \PY{o}{=} \PY{n}{pd}\PY{o}{.}\PY{n}{concat}\PY{p}{(}\PY{n+nb}{list}\PY{p}{,} \PY{n}{axis}\PY{o}{=}\PY{l+m+mi}{0}\PY{p}{,} \PY{n}{keys} \PY{o}{=} \PY{n}{files}\PY{p}{)}
\end{Verbatim}


    \subsection{Use Dutch tokeniser rules}


    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}879}]:} \PY{n}{settingsfile} \PY{o}{=} \PY{l+s}{\PYZdq{}}\PY{l+s}{/etc/ucto/tokconfig\PYZhy{}nl\PYZhy{}twitter}\PY{l+s}{\PYZdq{}}
          \PY{n}{tokenizer} \PY{o}{=} \PY{n}{ucto}\PY{o}{.}\PY{n}{Tokenizer}\PY{p}{(}\PY{n}{settingsfile}\PY{p}{)}
          
          \PY{k}{def} \PY{n+nf}{remove\PYZus{}non\PYZus{}ascii}\PY{p}{(}\PY{n}{s}\PY{p}{)}\PY{p}{:}
              \PY{k}{return} \PY{l+s}{\PYZdq{}}\PY{l+s}{\PYZdq{}}\PY{o}{.}\PY{n}{join}\PY{p}{(}\PY{n}{i} \PY{k}{for} \PY{n}{i} \PY{o+ow}{in} \PY{n}{s} \PY{k}{if} \PY{n+nb}{ord}\PY{p}{(}\PY{n}{i}\PY{p}{)} \PY{o}{\PYZlt{}} \PY{l+m+mi}{128}\PY{p}{)}
          
          \PY{k}{def} \PY{n+nf}{ucto\PYZus{}tokenizer}\PY{p}{(}\PY{n+nb}{str}\PY{p}{)}\PY{p}{:}
              \PY{n}{remove\PYZus{}non\PYZus{}ascii}\PY{p}{(}\PY{n+nb}{str}\PY{p}{)}
              \PY{n}{tokenizer}\PY{o}{.}\PY{n}{process}\PY{p}{(}\PY{n+nb}{unicode}\PY{p}{(}\PY{n+nb}{str}\PY{p}{)}\PY{p}{)}
              \PY{n}{tokens} \PY{o}{=} \PY{p}{[}\PY{n+nb}{unicode}\PY{p}{(}\PY{n}{token}\PY{p}{)}\PY{o}{.}\PY{n}{encode}\PY{p}{(}\PY{l+s}{\PYZsq{}}\PY{l+s}{utf\PYZhy{}8}\PY{l+s}{\PYZsq{}}\PY{p}{)} \PY{k}{for} \PY{n}{token} \PY{o+ow}{in} \PY{n}{tokenizer}\PY{p}{]}
              \PY{k}{for} \PY{n}{pos}\PY{p}{,} \PY{n}{token} \PY{o+ow}{in} \PY{n+nb}{enumerate}\PY{p}{(}\PY{n}{tokens}\PY{p}{)}\PY{p}{:} 
                  \PY{k}{if} \PY{n}{token}\PY{o}{.}\PY{n}{startswith}\PY{p}{(}\PY{l+s}{\PYZsq{}}\PY{l+s}{http:}\PY{l+s}{\PYZsq{}}\PY{p}{)}\PY{p}{:} \PY{n}{tokens}\PY{p}{[}\PY{n}{pos}\PY{p}{]} \PY{o}{=} \PY{l+s}{\PYZsq{}}\PY{l+s}{url}\PY{l+s}{\PYZsq{}}
                  \PY{k}{if} \PY{n}{token}\PY{o}{.}\PY{n}{startswith}\PY{p}{(}\PY{l+s}{\PYZsq{}}\PY{l+s}{@}\PY{l+s}{\PYZsq{}}\PY{p}{)}\PY{p}{:} \PY{n}{tokens}\PY{p}{[}\PY{n}{pos}\PY{p}{]} \PY{o}{=} \PY{l+s}{\PYZsq{}}\PY{l+s}{user}\PY{l+s}{\PYZsq{}}
              \PY{k}{return} \PY{n}{tokens}
          
          
          \PY{n}{ucto\PYZus{}tokenizer}\PY{p}{(}\PY{l+s}{\PYZdq{}}\PY{l+s}{Was geht \PYZsh{}leute \PYZsh{}heute @POld hey? http://tinyurl.com/dasd}\PY{l+s}{\PYZdq{}}\PY{p}{)}
\end{Verbatim}

            \begin{Verbatim}[commandchars=\\\{\}]
{\color{outcolor}Out[{\color{outcolor}879}]:} ['Was', 'geht', '\#', 'leute', '\#', 'heute', 'user', 'hey', '?', 'url']
\end{Verbatim}
        

    \subsection{Aggressive Hashtags - Wordlist}


    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}880}]:} \PY{c}{\PYZsh{} The wordlist is a dictionary of profanity words.}
          \PY{n}{wordlists} \PY{o}{=} \PY{p}{\PYZob{}}\PY{p}{\PYZcb{}}
          \PY{c}{\PYZsh{} for name in [\PYZdq{}illness\PYZdq{}, \PYZdq{}religion\PYZdq{}, \PYZdq{}sexuality\PYZdq{}, \PYZdq{}slurs\PYZdq{}, \PYZdq{}misc\PYZdq{}]:}
          \PY{k}{for} \PY{n}{name} \PY{o+ow}{in} \PY{p}{[}\PY{l+s}{\PYZdq{}}\PY{l+s}{selection}\PY{l+s}{\PYZdq{}}\PY{p}{]}\PY{p}{:}
              \PY{k}{with} \PY{n+nb}{open}\PY{p}{(}\PY{l+s}{\PYZdq{}}\PY{l+s}{wordlist\PYZus{}}\PY{l+s}{\PYZdq{}} \PY{o}{+} \PY{n}{name} \PY{o}{+} \PY{l+s}{\PYZdq{}}\PY{l+s}{.txt}\PY{l+s}{\PYZdq{}}\PY{p}{)} \PY{k}{as} \PY{n}{f}\PY{p}{:}
                  \PY{n}{words} \PY{o}{=} \PY{n}{f}\PY{o}{.}\PY{n}{read}\PY{p}{(}\PY{p}{)}\PY{o}{.}\PY{n}{splitlines}\PY{p}{(}\PY{p}{)}
                  \PY{n}{wordlists}\PY{p}{[}\PY{n}{name}\PY{p}{]} \PY{o}{=} \PY{n}{words}
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}881}]:} \PY{n}{consumer\PYZus{}key} \PY{o}{=} \PY{l+s}{\PYZsq{}}\PY{l+s}{zdprSqld7JxkSjaeqQppemW5y}\PY{l+s}{\PYZsq{}}
          \PY{n}{consumer\PYZus{}secret} \PY{o}{=} \PY{l+s}{\PYZsq{}}\PY{l+s}{QMZCPjMZnqJjkXQxXerHGCP11PGXIrl7iXH0HnrlLUjwNVOQdY}\PY{l+s}{\PYZsq{}}
          \PY{n}{access\PYZus{}token} \PY{o}{=} \PY{l+s}{\PYZsq{}}\PY{l+s}{1612711080\PYZhy{}64a9w2e4BOTV4id4HTqLpzaO8Z6ag0pNVE9axZv}\PY{l+s}{\PYZsq{}}
          \PY{n}{access\PYZus{}token\PYZus{}secret} \PY{o}{=} \PY{l+s}{\PYZsq{}}\PY{l+s}{iGBJ7jTo7LjqdMWyU8sJT5xX6CllWX0YoeQScYxpbGjMr}\PY{l+s}{\PYZsq{}}
\end{Verbatim}


    \subsection{Connect to Twitter}


    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}882}]:} \PY{n}{auth} \PY{o}{=} \PY{n}{tweepy}\PY{o}{.}\PY{n}{OAuthHandler}\PY{p}{(}\PY{n}{consumer\PYZus{}key}\PY{p}{,} \PY{n}{consumer\PYZus{}secret}\PY{p}{)}
...
\end{Verbatim}
    ...
    \subsection{Create a Query}


    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}883}]:} \PY{k}{def} \PY{n+nf}{create\PYZus{}query}\PY{p}{(}\PY{n}{wordlist}\PY{p}{)}\PY{p}{:}
              \PY{k}{return} \PY{l+s}{\PYZdq{}}\PY{l+s}{ OR }\PY{l+s}{\PYZdq{}}\PY{o}{.}\PY{n}{join}\PY{p}{(}\PY{n}{wordlist}\PY{p}{)}
          
          \PY{k}{def} \PY{n+nf}{create\PYZus{}negate\PYZus{}query}\PY{p}{(}\PY{n}{wordlist}\PY{p}{)}\PY{p}{:}
              \PY{k}{return} \PY{l+s}{\PYZdq{}}\PY{l+s}{ }\PY{l+s}{\PYZdq{}}\PY{o}{.}\PY{n}{join}\PY{p}{(}\PY{p}{[}\PY{l+s}{\PYZdq{}}\PY{l+s}{\PYZhy{}}\PY{l+s}{\PYZdq{}} \PY{o}{+} \PY{n}{word} \PY{k}{for} \PY{n}{word} \PY{o+ow}{in} \PY{n}{wordlist}\PY{p}{]}\PY{p}{)}
\end{Verbatim}


    \subsection{Collect Tweets}


    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}838}]:} \PY{n}{results\PYZus{}aggressive} \PY{o}{=} \PY{p}{[}\PY{p}{]}
          \PY{n}{results\PYZus{}non\PYZus{}aggressive} \PY{o}{=} \PY{p}{[}\PY{p}{]}
          
          \PY{n}{flattened\PYZus{}wordlist} \PY{o}{=} \PY{p}{[}\PY{n}{item} \PY{k}{for} \PY{n}{sublist} \PY{o+ow}{in} \PY{n}{wordlists}\PY{o}{.}\PY{n}{values}\PY{p}{(}\PY{p}{)} \PY{k}{for} \PY{n}{item} \PY{o+ow}{in} \PY{n}{sublist}\PY{p}{]}
          
          \PY{n}{query\PYZus{}pos} \PY{o}{=} \PY{n}{create\PYZus{}query}\PY{p}{(}\PY{n}{flattened\PYZus{}wordlist}\PY{p}{)}
          \PY{n}{query\PYZus{}neg} \PY{o}{=} \PY{n}{create\PYZus{}negate\PYZus{}query}\PY{p}{(}\PY{n}{flattened\PYZus{}wordlist}\PY{p}{)}
          
          \PY{c}{\PYZsh{} Aggressive Tweets}
          
          \PY{k}{for} \PY{n}{tweet} \PY{o+ow}{in} \PY{n}{tweepy}\PY{o}{.}\PY{n}{Cursor}\PY{p}{(}\PY{n}{api}\PY{o}{.}\PY{n}{search}\PY{p}{,} \PY{n}{q} \PY{o}{=} \PY{n}{query\PYZus{}pos}\PY{p}{,}  \PY{n}{lang} \PY{o}{=} \PY{l+s}{\PYZdq{}}\PY{l+s}{nl}\PY{l+s}{\PYZdq{}}\PY{p}{)}\PY{o}{.}\PY{n}{items}\PY{p}{(}\PY{l+m+mi}{1500}\PY{p}{)}\PY{p}{:}
              \PY{n}{results\PYZus{}aggressive}\PY{o}{.}\PY{n}{append}\PY{p}{(}\PY{n}{tweet}\PY{p}{)}
              
          \PY{n}{time}\PY{o}{.}\PY{n}{sleep}\PY{p}{(}\PY{l+m+mi}{60}\PY{p}{)}
          
          \PY{c}{\PYZsh{} Non\PYZhy{}aggressive Tweets}
          
          \PY{k}{for} \PY{n}{tweet} \PY{o+ow}{in} \PY{n}{tweepy}\PY{o}{.}\PY{n}{Cursor}\PY{p}{(}\PY{n}{api}\PY{o}{.}\PY{n}{search}\PY{p}{,} \PY{n}{q} \PY{o}{=} \PY{n}{query\PYZus{}neg}\PY{p}{,}  \PY{n}{lang} \PY{o}{=} \PY{l+s}{\PYZdq{}}\PY{l+s}{nl}\PY{l+s}{\PYZdq{}}\PY{p}{)}\PY{o}{.}\PY{n}{items}\PY{p}{(}\PY{n+nb}{len}\PY{p}{(}\PY{n}{results\PYZus{}aggressive}\PY{p}{)}\PY{p}{)}\PY{p}{:}
              \PY{n}{results\PYZus{}non\PYZus{}aggressive}\PY{o}{.}\PY{n}{append}\PY{p}{(}\PY{n}{tweet}\PY{p}{)}   
\end{Verbatim}


    \subsection{Count Hashtags}


    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}885}]:} \PY{n}{flattened\PYZus{}wordlist} \PY{o}{=} \PY{p}{[}\PY{n}{item} \PY{k}{for} \PY{n}{sublist} \PY{o+ow}{in} \PY{n}{wordlists}\PY{o}{.}\PY{n}{values}\PY{p}{(}\PY{p}{)} \PY{k}{for} \PY{n}{item} \PY{o+ow}{in} \PY{n}{sublist}\PY{p}{]}
          \PY{n}{hash\PYZus{}dict} \PY{o}{=} \PY{p}{\PYZob{}} \PY{p}{\PYZcb{}}
          
          \PY{k}{for} \PY{n}{word} \PY{o+ow}{in} \PY{n}{flattened\PYZus{}wordlist}\PY{p}{:}
              \PY{n}{hash\PYZus{}dict}\PY{p}{[}\PY{n}{word}\PY{p}{]} \PY{o}{=} \PY{l+m+mi}{0}
          
          \PY{k}{for} \PY{n}{tweet} \PY{o+ow}{in} \PY{n}{results\PYZus{}aggressive}\PY{p}{:}
              \PY{k}{for} \PY{n}{word} \PY{o+ow}{in} \PY{n}{flattened\PYZus{}wordlist}\PY{p}{:}
                  \PY{k}{if} \PY{n}{word} \PY{o+ow}{in} \PY{n}{tweet}\PY{o}{.}\PY{n}{text}\PY{p}{:} \PY{n}{hash\PYZus{}dict}\PY{p}{[}\PY{n}{word}\PY{p}{]} \PY{o}{+}\PY{o}{=} \PY{l+m+mi}{1}
          
          \PY{k}{print}\PY{p}{(}\PY{n+nb}{len}\PY{p}{(}\PY{n}{results\PYZus{}aggressive}\PY{p}{)}\PY{p}{)}
          \PY{k}{print}\PY{p}{(}\PY{n+nb}{len}\PY{p}{(}\PY{n}{results\PYZus{}non\PYZus{}aggressive}\PY{p}{)}\PY{p}{)}
          \PY{k}{print}\PY{p}{(}\PY{n}{hash\PYZus{}dict}\PY{p}{)}
\end{Verbatim}
...
\{'\#idiot': 12, '\#fuckyou': 19, '\#gvd': 15, '\#sukkel': 42, '\#grrr': 60, '\#idioot': 48, '\#grr': 75\}
    ...
    \subsection{Additional Feature Extractor}


    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}842}]:} \PY{c}{\PYZsh{} The wordlist is a dictionary of profanity words.}
          \PY{n}{badwords} \PY{o}{=} \PY{p}{[}\PY{p}{]}
          \PY{k}{for} \PY{n}{name} \PY{o+ow}{in} \PY{p}{[}\PY{l+s}{\PYZdq{}}\PY{l+s}{illness}\PY{l+s}{\PYZdq{}}\PY{p}{,} \PY{l+s}{\PYZdq{}}\PY{l+s}{religion}\PY{l+s}{\PYZdq{}}\PY{p}{,} \PY{l+s}{\PYZdq{}}\PY{l+s}{sexuality}\PY{l+s}{\PYZdq{}}\PY{p}{,} \PY{l+s}{\PYZdq{}}\PY{l+s}{slurs}\PY{l+s}{\PYZdq{}}\PY{p}{,} \PY{l+s}{\PYZdq{}}\PY{l+s}{misc}\PY{l+s}{\PYZdq{}}\PY{p}{]}\PY{p}{:}
              \PY{k}{with} \PY{n+nb}{open}\PY{p}{(}\PY{l+s}{\PYZdq{}}\PY{l+s}{wordlist\PYZus{}}\PY{l+s}{\PYZdq{}} \PY{o}{+} \PY{n}{name} \PY{o}{+} \PY{l+s}{\PYZdq{}}\PY{l+s}{.txt}\PY{l+s}{\PYZdq{}}\PY{p}{)} \PY{k}{as} \PY{n}{f}\PY{p}{:}
                  \PY{n}{word} \PY{o}{=} \PY{n}{f}\PY{o}{.}\PY{n}{read}\PY{p}{(}\PY{p}{)}\PY{o}{.}\PY{n}{splitlines}\PY{p}{(}\PY{p}{)}
                  \PY{n}{badwords}\PY{o}{.}\PY{n}{append}\PY{p}{(}\PY{n}{word}\PY{p}{)}
                  
          \PY{k}{class} \PY{n+nc}{MyWordCounter}\PY{p}{(}\PY{n}{BaseEstimator}\PY{p}{)}\PY{p}{:}
              
              \PY{k}{def} \PY{n+nf}{\PYZus{}\PYZus{}init\PYZus{}\PYZus{}}\PY{p}{(}\PY{n+nb+bp}{self}\PY{p}{)}\PY{p}{:}
                  \PY{k}{with} \PY{n+nb}{open}\PY{p}{(}\PY{l+s}{\PYZdq{}}\PY{l+s}{my\PYZus{}badlist.txt}\PY{l+s}{\PYZdq{}}\PY{p}{)} \PY{k}{as} \PY{n}{f}\PY{p}{:}
                      \PY{n}{badwords} \PY{o}{=} \PY{p}{[}\PY{n}{l}\PY{o}{.}\PY{n}{strip}\PY{p}{(}\PY{p}{)} \PY{k}{for} \PY{n}{l} \PY{o+ow}{in} \PY{n}{f}\PY{o}{.}\PY{n}{readlines}\PY{p}{(}\PY{p}{)}\PY{p}{]}
                  \PY{n+nb+bp}{self}\PY{o}{.}\PY{n}{badwords\PYZus{}} \PY{o}{=} \PY{n}{badwords}
          
              \PY{k}{def} \PY{n+nf}{fit}\PY{p}{(}\PY{n+nb+bp}{self}\PY{p}{,} \PY{n}{documents}\PY{p}{,} \PY{n}{y}\PY{o}{=}\PY{n+nb+bp}{None}\PY{p}{)}\PY{p}{:}
                  \PY{k}{return} \PY{n+nb+bp}{self}
          
              \PY{k}{def} \PY{n+nf}{transform}\PY{p}{(}\PY{n+nb+bp}{self}\PY{p}{,} \PY{n}{documents}\PY{p}{)}\PY{p}{:}
                  
                  \PY{n}{n\PYZus{}words} \PY{o}{=} \PY{p}{[}\PY{n+nb}{len}\PY{p}{(}\PY{n}{ucto\PYZus{}tokenizer}\PY{p}{(}\PY{n}{remove\PYZus{}non\PYZus{}ascii}\PY{p}{(}\PY{n}{tweet}\PY{p}{)}\PY{p}{)}\PY{p}{)} \PY{k}{for} \PY{n}{tweet} \PY{o+ow}{in} \PY{n}{documents}\PY{p}{]}
                  \PY{n}{n\PYZus{}chars} \PY{o}{=} \PY{p}{[}\PY{n+nb}{len}\PY{p}{(}\PY{n}{tweet}\PY{p}{)} \PY{k}{for} \PY{n}{tweet} \PY{o+ow}{in} \PY{n}{documents}\PY{p}{]}
                  \PY{c}{\PYZsh{} number of uppercase words}
          
                  \PY{n}{allcaps} \PY{o}{=} \PY{p}{[}\PY{n}{np}\PY{o}{.}\PY{n}{sum}\PY{p}{(}\PY{p}{[}\PY{n}{w}\PY{o}{.}\PY{n}{isupper}\PY{p}{(}\PY{p}{)} \PY{k}{for} \PY{n}{w} \PY{o+ow}{in} \PY{n}{comment}\PY{o}{.}\PY{n}{split}\PY{p}{(}\PY{p}{)}\PY{p}{]}\PY{p}{)}
                         \PY{k}{for} \PY{n}{comment} \PY{o+ow}{in} \PY{n}{documents}\PY{p}{]}
                  
                  \PY{c}{\PYZsh{} longest word}
                  \PY{n}{max\PYZus{}word\PYZus{}len} \PY{o}{=} \PY{p}{[}\PY{n}{np}\PY{o}{.}\PY{n}{max}\PY{p}{(}\PY{p}{[}\PY{n+nb}{len}\PY{p}{(}\PY{n}{w}\PY{p}{)} \PY{k}{for} \PY{n}{w} \PY{o+ow}{in} \PY{n}{c}\PY{o}{.}\PY{n}{split}\PY{p}{(}\PY{p}{)}\PY{p}{]}\PY{p}{)} \PY{k}{for} \PY{n}{c} \PY{o+ow}{in} \PY{n}{documents}\PY{p}{]}
                  \PY{c}{\PYZsh{} average word length}
                  \PY{n}{mean\PYZus{}word\PYZus{}len} \PY{o}{=} \PY{p}{[}\PY{n}{np}\PY{o}{.}\PY{n}{mean}\PY{p}{(}\PY{p}{[}\PY{n+nb}{len}\PY{p}{(}\PY{n}{w}\PY{p}{)} \PY{k}{for} \PY{n}{w} \PY{o+ow}{in} \PY{n}{c}\PY{o}{.}\PY{n}{split}\PY{p}{(}\PY{p}{)}\PY{p}{]}\PY{p}{)}
                                                      \PY{k}{for} \PY{n}{c} \PY{o+ow}{in} \PY{n}{documents}\PY{p}{]}
                  \PY{c}{\PYZsh{} number of badwords:}
                  \PY{n}{n\PYZus{}bad} \PY{o}{=} \PY{p}{[}\PY{n}{np}\PY{o}{.}\PY{n}{sum}\PY{p}{(}\PY{p}{[}\PY{n}{c}\PY{o}{.}\PY{n}{lower}\PY{p}{(}\PY{p}{)}\PY{o}{.}\PY{n}{count}\PY{p}{(}\PY{n}{w}\PY{p}{)} \PY{k}{for} \PY{n}{w} \PY{o+ow}{in} \PY{n+nb+bp}{self}\PY{o}{.}\PY{n}{badwords\PYZus{}}\PY{p}{]}\PY{p}{)}
                                                          \PY{k}{for} \PY{n}{c} \PY{o+ow}{in} \PY{n}{documents}\PY{p}{]}
                  \PY{n}{exclamation} \PY{o}{=} \PY{p}{[}\PY{n}{c}\PY{o}{.}\PY{n}{count}\PY{p}{(}\PY{l+s}{\PYZdq{}}\PY{l+s}{!}\PY{l+s}{\PYZdq{}}\PY{p}{)} \PY{k}{for} \PY{n}{c} \PY{o+ow}{in} \PY{n}{documents}\PY{p}{]}
                  \PY{n}{addressing} \PY{o}{=} \PY{p}{[}\PY{n}{c}\PY{o}{.}\PY{n}{count}\PY{p}{(}\PY{l+s}{\PYZdq{}}\PY{l+s}{@}\PY{l+s}{\PYZdq{}}\PY{p}{)} \PY{k}{for} \PY{n}{c} \PY{o+ow}{in} \PY{n}{documents}\PY{p}{]}
                  \PY{n}{spaces} \PY{o}{=} \PY{p}{[}\PY{n}{c}\PY{o}{.}\PY{n}{count}\PY{p}{(}\PY{l+s}{\PYZdq{}}\PY{l+s}{ }\PY{l+s}{\PYZdq{}}\PY{p}{)} \PY{k}{for} \PY{n}{c} \PY{o+ow}{in} \PY{n}{documents}\PY{p}{]}
          
                  \PY{n}{allcaps\PYZus{}ratio} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{array}\PY{p}{(}\PY{n}{allcaps}\PY{p}{)} \PY{o}{/} \PY{n}{np}\PY{o}{.}\PY{n}{array}\PY{p}{(}\PY{n}{n\PYZus{}words}\PY{p}{,} \PY{n}{dtype}\PY{o}{=}\PY{n}{np}\PY{o}{.}\PY{n}{float}\PY{p}{)}
                  \PY{n}{bad\PYZus{}ratio} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{array}\PY{p}{(}\PY{n}{n\PYZus{}bad}\PY{p}{)} \PY{o}{/} \PY{n}{np}\PY{o}{.}\PY{n}{array}\PY{p}{(}\PY{n}{n\PYZus{}words}\PY{p}{,} \PY{n}{dtype}\PY{o}{=}\PY{n}{np}\PY{o}{.}\PY{n}{float}\PY{p}{)}
          
                  \PY{k}{return} \PY{n}{np}\PY{o}{.}\PY{n}{array}\PY{p}{(}\PY{p}{[}\PY{n}{n\PYZus{}words}
                                   \PY{p}{,} \PY{n}{n\PYZus{}chars}
                                  \PY{p}{,} \PY{n}{allcaps}
                                  \PY{p}{,} \PY{n}{max\PYZus{}word\PYZus{}len}
                                  \PY{p}{,} \PY{n}{mean\PYZus{}word\PYZus{}len}
                                  \PY{p}{,} \PY{n}{exclamation}
                                  \PY{p}{,} \PY{n}{addressing}
                                  \PY{p}{,} \PY{n}{spaces}
                                  \PY{p}{,} \PY{n}{bad\PYZus{}ratio}
                                  \PY{p}{,} \PY{n}{n\PYZus{}bad}
                                  \PY{p}{,} \PY{n}{allcaps\PYZus{}ratio}
          \PY{p}{]}\PY{p}{)}\PY{o}{.}\PY{n}{T} 
\end{Verbatim}


    \subsection{Define Pipeline}


    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}913}]:} \PY{k}{with} \PY{n+nb}{open}\PY{p}{(}\PY{l+s}{\PYZdq{}}\PY{l+s}{dutch\PYZhy{}stop\PYZhy{}words.txt}\PY{l+s}{\PYZdq{}}\PY{p}{)} \PY{k}{as} \PY{n}{f}\PY{p}{:}
              \PY{n}{dutch\PYZus{}stop\PYZus{}words} \PY{o}{=} \PY{n}{f}\PY{o}{.}\PY{n}{read}\PY{p}{(}\PY{p}{)}\PY{o}{.}\PY{n}{splitlines}\PY{p}{(}\PY{p}{)}
                  
          \PY{n}{count\PYZus{}vect} \PY{o}{=} \PY{n}{CountVectorizer}\PY{p}{(}\PY{n}{stop\PYZus{}words} \PY{o}{=} \PY{n}{dutch\PYZus{}stop\PYZus{}words}
                                       \PY{p}{,} \PY{n}{tokenizer} \PY{o}{=} \PY{n}{ucto\PYZus{}tokenizer}
                                       \PY{p}{,} \PY{n}{lowercase} \PY{o}{=} \PY{n+nb+bp}{True}\PY{p}{)}
              
          \PY{n}{my\PYZus{}Counter} \PY{o}{=} \PY{n}{MyWordCounter}\PY{p}{(}\PY{p}{)}
          
          \PY{n}{combined} \PY{o}{=} \PY{n}{FeatureUnion}\PY{p}{(}\PY{p}{[}\PY{p}{(}\PY{l+s}{\PYZdq{}}\PY{l+s}{clf1}\PY{l+s}{\PYZdq{}}\PY{p}{,} \PY{n}{count\PYZus{}vect}\PY{p}{)}\PY{p}{,} \PY{p}{(}\PY{l+s}{\PYZdq{}}\PY{l+s}{clf2}\PY{l+s}{\PYZdq{}}\PY{p}{,} \PY{n}{my\PYZus{}Counter}\PY{p}{)}\PY{p}{]}\PY{p}{)}
              
          \PY{n}{tfidf} \PY{o}{=} \PY{n}{TfidfTransformer}\PY{p}{(}\PY{n}{sublinear\PYZus{}tf} \PY{o}{=} \PY{n+nb+bp}{True}
                                  \PY{p}{,} \PY{n}{use\PYZus{}idf} \PY{o}{=} \PY{n+nb+bp}{True}
                                  \PY{p}{)}    
          
          
          \PY{n}{clf} \PY{o}{=} \PY{n}{LogisticRegression}\PY{p}{(}\PY{n}{penalty} \PY{o}{=} \PY{l+s}{\PYZsq{}}\PY{l+s}{l2}\PY{l+s}{\PYZsq{}}\PY{p}{,} \PY{n}{dual} \PY{o}{=} \PY{n+nb+bp}{False}\PY{p}{)}\PY{c}{\PYZsh{} NuSVC(nu = 0.4) }
          
          \PY{c}{\PYZsh{} or logistic regression ! (could be easier and better to explain)}
          
          \PY{k+kn}{from} \PY{n+nn}{sklearn.pipeline} \PY{k+kn}{import} \PY{n}{Pipeline}
          \PY{n}{pipeline} \PY{o}{=} \PY{n}{Pipeline}\PY{p}{(}\PY{p}{[}\PY{p}{(}\PY{l+s}{\PYZsq{}}\PY{l+s}{vect}\PY{l+s}{\PYZsq{}}\PY{p}{,} \PY{n}{combined}\PY{p}{)}\PY{p}{,}
                               \PY{p}{(}\PY{l+s}{\PYZsq{}}\PY{l+s}{tfidf}\PY{l+s}{\PYZsq{}}\PY{p}{,} \PY{n}{tfidf}\PY{p}{)}\PY{p}{,} 
                               \PY{p}{(}\PY{l+s}{\PYZsq{}}\PY{l+s}{clf}\PY{l+s}{\PYZsq{}}\PY{p}{,} \PY{n}{clf}\PY{p}{)}\PY{p}{]}\PY{p}{)}
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}914}]:} \PY{n}{accuracy\PYZus{}per\PYZus{}fold} \PY{o}{=} \PY{p}{[}\PY{p}{]}
          
          \PY{k}{for} \PY{n}{x} \PY{o+ow}{in} \PY{n+nb}{xrange}\PY{p}{(}\PY{l+m+mi}{0}\PY{p}{,} \PY{l+m+mi}{10}\PY{p}{)}\PY{p}{:}
              \PY{n}{train} \PY{o}{=} \PY{n}{frame}\PY{o}{.}\PY{n}{ix}\PY{p}{[}\PY{p}{[}\PY{n}{create\PYZus{}key}\PY{p}{(}\PY{n}{y}\PY{p}{)} \PY{k}{for} \PY{n}{y} \PY{o+ow}{in} \PY{n+nb}{range}\PY{p}{(}\PY{l+m+mi}{0}\PY{p}{,}\PY{l+m+mi}{10}\PY{p}{)} \PY{k}{if} \PY{n}{x} \PY{o}{!=} \PY{n}{y}\PY{p}{]}\PY{p}{]}
          \PY{c}{\PYZsh{}     test = frame.ix[create\PYZus{}key(x)]}
              
              \PY{n}{messages\PYZus{}train} \PY{o}{=} \PY{n}{train}\PY{p}{[}\PY{l+s}{\PYZsq{}}\PY{l+s}{message}\PY{l+s}{\PYZsq{}}\PY{p}{]}
              \PY{n}{categories\PYZus{}train} \PY{o}{=} \PY{n}{train}\PY{p}{[}\PY{l+s}{\PYZsq{}}\PY{l+s}{category}\PY{l+s}{\PYZsq{}}\PY{p}{]}
              
              \PY{n}{messages\PYZus{}test} \PY{o}{=} \PY{n}{test}\PY{p}{[}\PY{l+s}{\PYZsq{}}\PY{l+s}{message}\PY{l+s}{\PYZsq{}}\PY{p}{]}
              \PY{n}{categories\PYZus{}test} \PY{o}{=} \PY{n}{test}\PY{p}{[}\PY{l+s}{\PYZsq{}}\PY{l+s}{category}\PY{l+s}{\PYZsq{}}\PY{p}{]}
              
              \PY{c}{\PYZsh{} train classifier }
              \PY{n}{pipeline} \PY{o}{=} \PY{n}{pipeline}\PY{o}{.}\PY{n}{fit}\PY{p}{(}\PY{n}{messages\PYZus{}train}\PY{p}{,} \PY{n}{categories\PYZus{}train}\PY{p}{)}
              
              \PY{n}{predicted} \PY{o}{=} \PY{n}{pipeline}\PY{o}{.}\PY{n}{predict}\PY{p}{(}\PY{n}{messages\PYZus{}test}\PY{p}{)}
              \PY{n}{accuracy} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{mean}\PY{p}{(}\PY{n}{predicted} \PY{o}{==} \PY{n}{categories\PYZus{}test}\PY{p}{)}
              \PY{n}{accuracy\PYZus{}per\PYZus{}fold}\PY{o}{.}\PY{n}{append}\PY{p}{(}\PY{n}{accuracy}\PY{p}{)}
              \PY{k}{print}\PY{p}{(}\PY{n}{accuracy}\PY{p}{)}
              
          \PY{k}{print}\PY{p}{(}\PY{l+s}{\PYZdq{}}\PY{l+s}{Total average accuracy: }\PY{l+s}{\PYZdq{}}\PY{p}{,} \PY{n}{np}\PY{o}{.}\PY{n}{mean}\PY{p}{(}\PY{n}{accuracy\PYZus{}per\PYZus{}fold}\PY{p}{)}\PY{p}{)}
\end{Verbatim}
...
('Total average accuracy: ', 0.87111111111111117)
    ...
    \subsection{Run Classification and Evaluation}


    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}915}]:} \PY{n}{aggressive\PYZus{}train} \PY{o}{=}  \PY{p}{[}\PY{n}{tweet}\PY{o}{.}\PY{n}{text} \PY{k}{for} \PY{n}{tweet} \PY{o+ow}{in} \PY{n}{results\PYZus{}aggressive}\PY{p}{]}
          \PY{n}{non\PYZus{}aggressive\PYZus{}train} \PY{o}{=} \PY{p}{[}\PY{n}{tweet}\PY{o}{.}\PY{n}{text} \PY{k}{for} \PY{n}{tweet} \PY{o+ow}{in} \PY{n}{results\PYZus{}non\PYZus{}aggressive}\PY{p}{]}
          
          \PY{n}{messages\PYZus{}train} \PY{o}{=} \PY{n}{aggressive\PYZus{}train} \PY{o}{+} \PY{n}{non\PYZus{}aggressive\PYZus{}train}
          
          \PY{n}{categories\PYZus{}train} \PY{o}{=} \PY{p}{[}\PY{l+s}{\PYZsq{}}\PY{l+s}{aggressive}\PY{l+s}{\PYZsq{}}\PY{p}{]} \PY{o}{*} \PY{n+nb}{len}\PY{p}{(}\PY{n}{aggressive\PYZus{}train}\PY{p}{)} \PYZbs{}
                           \PY{o}{+} \PY{p}{[}\PY{l+s}{\PYZsq{}}\PY{l+s}{non\PYZus{}aggressive}\PY{l+s}{\PYZsq{}}\PY{p}{]} \PY{o}{*} \PY{n+nb}{len}\PY{p}{(}\PY{n}{non\PYZus{}aggressive\PYZus{}train}\PY{p}{)}
          
          \PY{n}{pipeline} \PY{o}{=} \PY{n}{pipeline}\PY{o}{.}\PY{n}{fit}\PY{p}{(}\PY{n}{messages\PYZus{}train}\PY{p}{,} \PY{n}{categories\PYZus{}train}\PY{p}{)}
          \PY{c}{\PYZsh{} }
          \PY{n}{accuracy\PYZus{}per\PYZus{}fold} \PY{o}{=} \PY{p}{[}\PY{p}{]}
          \PY{k}{for} \PY{n}{x} \PY{o+ow}{in} \PY{n+nb}{xrange}\PY{p}{(}\PY{l+m+mi}{0}\PY{p}{,} \PY{l+m+mi}{10}\PY{p}{)}\PY{p}{:}
              \PY{n}{test} \PY{o}{=} \PY{n}{frame}\PY{o}{.}\PY{n}{ix}\PY{p}{[}\PY{n}{create\PYZus{}key}\PY{p}{(}\PY{n}{x}\PY{p}{)}\PY{p}{]}
              ...
              \PY{n}{accuracy\PYZus{}per\PYZus{}fold}\PY{o}{.}\PY{n}{append}\PY{p}{(}\PY{n}{accuracy}\PY{p}{)}  
              \PY{k}{print}\PY{p}{(}\PY{n}{metrics}\PY{o}{.}\PY{n}{classification\PYZus{}report}\PY{p}{(}\PY{n}{categories\PYZus{}test}\PY{p}{,} \PY{n}{predicted}\PY{p}{)}\PY{p}{)}
...
non\_aggressive       0.72      0.67      0.69       158
...
non\_aggressive       0.73      0.69      0.71       158
...
('Total average accuracy: ', 0.71949747599001335)
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}924}]:} \PY{n}{interactive\PYZus{}test} \PY{o}{=} \PY{p}{[}\PY{n+nb}{raw\PYZus{}input}\PY{p}{(}\PY{l+s}{\PYZsq{}}\PY{l+s}{Please type message that should be categorized: }\PY{l+s}{\PYZsq{}}\PY{p}{)}\PY{p}{]}
          
          \PY{n}{train} \PY{o}{=} \PY{n}{frame}\PY{o}{.}\PY{n}{ix}\PY{p}{[}\PY{p}{[}\PY{n}{create\PYZus{}key}\PY{p}{(}\PY{n}{y}\PY{p}{)} \PY{k}{for} \PY{n}{y} \PY{o+ow}{in} \PY{n+nb}{range}\PY{p}{(}\PY{l+m+mi}{0}\PY{p}{,}\PY{l+m+mi}{10}\PY{p}{)}\PY{p}{]}\PY{p}{]}
          ...
          \PY{n}{predicted} \PY{o}{=} \PY{n}{pipeline}\PY{o}{.}\PY{n}{predict}\PY{p}{(}\PY{n}{interactive\PYZus{}test}\PY{p}{)}
          \PY{k}{print}\PY{p}{(}\PY{n}{predicted}\PY{p}{)}
\end{Verbatim}
